...
对文件夹内的多个obj文件进行操作
"""
obj_dir_path="./obj_file"
file_list=os.listdir(obj_dir_path)

for file in file_list:
    print(f"file: {file}")
    obj_file_path=os.path.join(obj_dir_path,file)
    ...
    output_file_name=file.split(".")[0]+".png"
